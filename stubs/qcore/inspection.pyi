import inspect
import types
from typing import Any, Callable, Iterable, List, Mapping, Sequence, Type, TypeVar, Union
...
def get_function_call_str(fn: Callable[..., Any], args: Iterable[object], kwargs: Mapping[str, object]) -> str: ...
def get_function_call_repr(fn: Callable[..., Any], args: Iterable[object], kwargs: Mapping[str, object]) -> str: ...
def getargspec(func: Union[types.FunctionType, types.MethodType]) -> inspect.ArgSpec: ...
