from typing import Any, Callable, Iterable, Mapping, Optional, SupportsInt, Type, TypeVar
...
def utime_delta(*, days: int = ..., hours: int = ..., minutes: int = ..., seconds: int = ...) -> int: ...
...
def execute_with_timeout(fn: Callable[..., _T], args: Optional[Iterable[Any]] = ...,
                         kwargs: Optional[Mapping[str, Any]] = ..., timeout: Optional[float] = ...,
                         fail_if_no_timer: bool = ...,
                         signal_type: int = ...,
                         timer_type: int = ...,
                         timeout_exception_cls: Type[BaseException] = ...) -> _T: ...
